...
def record_ogg(filename="recording.ogg", buttonState=True):#, duration=30):   # sec
    c=0;
    last = 1
...
async def button_record_task():
    global buttonState, last, recording_active
...
async def audio_stream_task():
    ...
    while True:
        ...
        current_file.close()
        print("finished 30 seconde stream")
    ...
    while True:
        ...
        try:
            async with await aioble.advertise(
                ...
                services=[SERVICE1_UUID, SERVICE2_UUID, SERVICE3_UUID],
                ) as connection:
